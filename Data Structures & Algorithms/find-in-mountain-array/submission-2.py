class Solution:
    def findInMountainArray(self, target: int, mountainArr: 
        ...
        # run binary serach three times, once to find peak
        # then two more times to look on the left and right side
        # of the peak, noting that the righty side is 
        # sorteed descending so the logix is flippped.
